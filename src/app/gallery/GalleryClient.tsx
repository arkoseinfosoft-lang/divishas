        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-4 sm:space-y-6">
            ...
            <p className="text-sm sm:text-base md:text-lg text-[#554e53] font-normal font-sans leading-relaxed">
              Browse our portfolio of bespoke hair transformations, couture bridal makeup, men&apos;s precision grooming, and nail styling from Divisha&apos;s Unisex Salon, Kanpur.
            </p>
          </div>
      ...
      <section className="py-16 sm:py-24 md:py-32 bg-white border-b border-[#EAE3E6]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {filteredItems.map((item) => (
              ...
              >
                ...
                <div className="p-6 sm:p-7 space-y-2">
                  <h2 className="font-serif text-lg sm:text-xl font-semibold text-[#181517] group-hover:text-[#C2185B] transition-colors leading-snug">
                    {item.title}
                  </h2>
          ...
          <div className="mt-14 sm:mt-18 text-center space-y-3">
            <p className="text-sm text-[#554e53]">
              Inspired by what you see?
            </p>
            <div className="flex flex-wrap items-center justify-center gap-3">
              <a
                href="/contact#appointment"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#C2185B] text-white text-xs sm:text-sm font-semibold hover:bg-[#A31545] transition-colors shadow-md min-h-[40px]"
              >
                Book This Look
              </a>
              <a
                href="/bridal"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-[#C2185B] text-[#C2185B] text-xs sm:text-sm font-semibold hover:bg-[#FCE4EC] transition-colors min-h-[40px]"
              >
                Bridal Packages
              </a>
              <a
                href="/services"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-[#EAE3E6] text-[#554e53] text-xs sm:text-sm font-semibold hover:border-[#C2185B] hover:text-[#C2185B] transition-colors min-h-[40px]"
              >
                All Services
              </a>
            </div>
          ...
          >
            ...
            <div className="p-5 sm:p-7 space-y-3 sm:space-y-4">
              <div className="flex items-center justify-between gap-4">
                ...
                <span className="text-xs text-[#8C8488]">Divisha&apos;s Unisex Salon, Kanpur</span>
              </div>
