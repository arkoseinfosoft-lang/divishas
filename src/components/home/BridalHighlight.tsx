...
export function BridalHighlight() {
  ...
  return (
    <section className="py-16 sm:py-24 bg-[#141213] text-white relative overflow-hidden">
      {/* Glow */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 relative">
            <div className="grid grid-cols-2 gap-4">
              <div className="relative h-72 sm:h-96 rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
                <Image
              ...
              <div className="space-y-4">
                ...
                <div className="relative h-24 sm:h-36 rounded-3xl overflow-hidden border border-white/10 bg-[#221C20] p-4 flex flex-col justify-center">
                  <div className="flex items-center gap-2 text-[#FF80AB] mb-1">
                    <Crown className="w-4 h-4" />
                    <span className="text-xs font-bold uppercase tracking-wider">
                      For Bride &amp; Groom
                    </span>
                  </div>
                  <p className="text-xs text-[#C8BFC4]">
          ...
          <div className="lg:col-span-6 space-y-6">
            <Badge variant="primary" className="bg-[#FF80AB]/20 text-[#FF80AB] border-[#FF80AB]/30">
            ...
            <p className="text-base text-[#B8B1B6] leading-relaxed font-sans">
            ...
            <div className="space-y-3 pt-2">
              {highlights.map((item) => (
                <div key={item} className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-[#E0D8DC] font-medium">{item}</span>
                </div>
              ))}
            </div>
