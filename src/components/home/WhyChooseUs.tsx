          ...
          >
            <div className="relative mx-auto max-w-md lg:max-w-none">
              <div className="relative h-96 sm:h-[480px] rounded-3xl overflow-hidden shadow-2xl shadow-black/10 border border-[#EAE3E6]">
                ...
                <div className="absolute bottom-6 left-6 right-6 p-5 rounded-2xl bg-white/95 backdrop-blur-md border border-white/50 shadow-xl flex items-center gap-4">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#E0007C] to-[#C2185B] text-white flex items-center justify-center shrink-0 shadow-md">
