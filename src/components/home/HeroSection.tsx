...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden pt-6 pb-12 sm:pt-10 sm:pb-16 md:pt-16 md:pb-24 lg:pt-20 lg:pb-28 bg-luxury-radial">
      {/* Background ambient lighting */}
      <div className="absolute top-1/4 right-0 w-72 sm:w-[500px] h-72 sm:h-[500px] bg-[#E0007C]/8 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-10 left-0 w-60 sm:w-[400px] h-60 sm:h-[400px] bg-[#D81B60]/5 rounded-full blur-3xl pointer-events-none" />
